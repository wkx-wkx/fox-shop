<template>
  <div class="app-container">
    <el-card shadow="never" class="operate-container">
      ...
      <el-button size="mini" class="btn-add" @click="returnList()">返回资源列表</el-button>
    </el-card>
...
<script>
  import {
    ...
    fetchResourceCategoryById, listAllCate,
    ...
    export default {
      ...
      methods: {
          ...
          handleUpdate(index,row){
            fetchResourceCategoryById(row.id).then(result =>{
          ...
          handleDialogConfirm(){
            this.$confirm('是否要确认?', '提示', {
              ...
              if (this.isEdit) {
                saveOrUpdateResourceCategory(this.resourceCategory).then(response => {
                  this.$message({
                    message: '修改成功！',
                    type: 'success'
                  });
