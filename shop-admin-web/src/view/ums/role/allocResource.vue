...
<script>
  import {fetchAllResourceList} from '@/api/ums/role';
  import {fetchCategoryOptions as listAllCate,listResourceByRole,saveResourceByRole} from '@/api/ums/resource';
    ...
    methods: {
      ...
      handleSave() {
        this.$confirm('是否分配资源？', '提示', {
          ...
          saveResourceByRole(this.roleId,this.roleResourceList).then(response => {
            this.$message({
              message: '分配成功',
              type: 'success',
              duration: 1000
